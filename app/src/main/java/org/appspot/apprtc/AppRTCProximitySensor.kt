...
import org.appspot.apprtc.util.AppRTCUtils.assertIsTrue
import org.appspot.apprtc.util.AppRTCUtils.threadInfo
 ...
 */
class AppRTCProximitySensor private constructor(context: Context, sensorStateListener: Runnable) : SensorEventListener {
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        Log.d(TAG, "onSensorChanged" + threadInfo + ": "
    ...
    init {
        Log.d(TAG, "AppRTCProximitySensor" + threadInfo)
