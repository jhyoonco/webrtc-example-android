 ...
 * AppRTC demo.
 */
class AppRTCBluetoothManager protected constructor(context: Context, audioManager: AppRTCAudioManager) {
    ...
    protected fun getBluetoothProfileProxy(
            context: Context?, listener: ServiceListener?, profile: Int): Boolean {
