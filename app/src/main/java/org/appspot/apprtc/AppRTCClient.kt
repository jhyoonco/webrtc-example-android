...
interface AppRTCClient {
    ...
    class RoomConnectionParameters @JvmOverloads constructor(
            val roomUrl: String, val roomId: String, val loopback: Boolean, val urlParameters: String? = null /* urlParameters */)
     ...
     */
    class SignalingParameters(val iceServers: List<IceServer>, val initiator: Boolean,
